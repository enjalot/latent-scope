...
def main():
    ...
    labeler(args.name, args.text_column, args.cluster_id, args.model_id, args.context)


def labeler(dataset_name, text_column="text", cluster_id="cluster-001", model_id="gpt-3.5-turbo", context=""):
