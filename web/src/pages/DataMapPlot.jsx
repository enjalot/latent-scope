...
function DataMapPlot() {
  ...
  useEffect(() => {
    console.log('fetching scope', datasetId, scopeId);
  ...
  const fileLink = useCallback(
    (d, i) => {
      return (
        <li className={styles['file-link']} key={i}>
          <a
            className={styles['config-link']}
            href={`${apiUrl}/files/${datasetId}/plots/${d[0]}`}
            target="_blank"
            rel="noreferrer"
          >
            {d[0]}
          ...
          <span className={styles['config-link']}>
            <a
              href={`${apiUrl}/files/${datasetId}/plots/${d[0].split('.png')[0]}.json`}
              target="_blank"
              rel="noreferrer"
            >
              [Config JSON]
  ...
  return (
    <div className={styles['page']}>
      ...
      <div className={styles['header']}>
        ...
        <Link to={`/datasets/${datasetId}/export/${scopeId}`}>
          Export data {dataset?.id} {scopeId}
        </Link> */}
      </div>
      <div className={styles['new-export']}>
        <h3>New Plot</h3>
        <p>
          This will create a new plot using{' '}
          <a href="https://datamapplot.readthedocs.io/en/latest/index.html">DataMapPlot</a>.
        </p>
        <form className={styles['config-form']} onSubmit={handleSubmit}>
          <div className={styles['label-group']}>
            ...
            <label>
              <span>Figure Size Width:</span>
              <input
                type="number"
                name="figsize.0"
                value={config.figsize[0]}
                onChange={handleChange}
              />
            </label>
            <label>
              <span>Figure Size Height:</span>
              <input
                type="number"
                name="figsize.1"
                value={config.figsize[1]}
                onChange={handleChange}
              />
            </label>
            <label>
              <span>Label Wrap Width:</span>
              <input
                type="number"
                name="label_wrap_width"
                value={config.label_wrap_width}
                onChange={handleChange}
              />
            </label>
            <label>
          ...
          <div className={styles['label-group']}>
            <label>
              <span>Label Over Points:</span>
              <input
                type="checkbox"
                name="label_over_points"
                checked={config.label_over_points}
                onChange={handleChange}
              />
            </label>
            <label>
              ...
              <input
                type="checkbox"
                name="dynamic_label_size"
                checked={config.dynamic_label_size}
                onChange={handleChange}
              />
            </label>
            <label>
            ...
            <label>
              ...
              <input
                type="number"
                name="min_font_size"
                value={config.min_font_size}
                onChange={handleChange}
              />
            </label>
            <label>
              <span>Min Font Weight:</span>
              <input
                type="number"
                name="min_font_weight"
                value={config.min_font_weight}
                onChange={handleChange}
              />
            </label>
            <label>
              <span>Max Font Weight:</span>
              <input
                type="number"
                name="max_font_weight"
                value={config.max_font_weight}
                onChange={handleChange}
              />
            </label>
            <label>
          ...
          <div className={styles['label-group']}>
            ...
            <label>
              ...
              <input
                type="number"
                name="glow_keywords.kernel_bandwidth"
                step="0.01"
                value={config.glow_keywords.kernel_bandwidth}
                onChange={handleChange}
              />
            </label>
            <label>
            ...
            <label>
              ...
              <input
                type="number"
                name="glow_keywords.n_levels"
                value={config.glow_keywords.n_levels}
                onChange={handleChange}
              />
            </label>
            <label>
              ...
              <input
                type="number"
                name="glow_keywords.max_alpha"
                step="0.01"
                value={config.glow_keywords.max_alpha}
                onChange={handleChange}
              />
            </label>
          </div>
        ...
        {plotJob && plotJob.status !== 'completed' ? (
          <p className={styles['warning']}>May take more than 30 seconds to see progress.</p>
        ) : null}
      </div>
