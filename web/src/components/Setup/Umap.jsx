        ...
        <div className={styles["umap-form"]}>
          ...
          <form onSubmit={handleNewUmap}>
            <label>
              ...
              <Tooltip id="neighbors" place="top" effect="solid" className={`${styles["tooltip"]} tooltip-area`}>
            ...
            <label>
              ...
              <Tooltip id="min-dist" place="top" effect="solid" className={`${styles["tooltip"]} tooltip-area`}>
            ...
            <div className={styles["umap-form-align"]}>
              ...
              <Tooltip id="align-umap" place="top" effect="solid" className={`${styles["tooltip"]} tooltip-area`}>
            ...
            {!showAlign && <div className={styles["umap-form-save"]}>
              ...
              <Tooltip id="save-umap" place="top" effect="solid" className={`${styles["tooltip"]} tooltip-area`}>
