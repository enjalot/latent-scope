...
/**
 * Legend for the Explore color-by. Numeric columns render a color ramp with the
 * min/max extent; categorical columns render one swatch per category (with
 * counts when available). Renders nothing when `legend` is null (color-by OFF).
 */
  ...
  return (
    <div className={styles.legend}>
      ...
      <div className={styles.swatches}>
        {categories.map((c) => (
          <div key={c.label} className={styles.swatchRow} title={c.label}>
