# Usage: python embed-togetherai.py <dataset_name> <text_column> <model_id>
import os
import sys
import time
import argparse
...
def embedder(dataset_name, text_column="text", model_id="togetherai-togethercomputer___m2-bert-80M-2k-retrieval"):
...
if __name__ == "__main__":
    ...
    parser.add_argument('model', type=str, help='Model ID of embedding model to use', default="togetherai-togethercomputer___m2-bert-80M-2k-retrieval")
